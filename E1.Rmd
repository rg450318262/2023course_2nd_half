...
test.outlier <- function(data, y, x){
  ...
  outlier.table <- data.frame(
    "Description" = NA, "x removed"= NA, "y removed"= NA,"MSE"= NA, "MSE reduction" = NA
    )
  #create id variable
  data$id <- 1:nrow(data)
...
The standard errors for regression coeﬀicient estimates for the data set d2 is 0.18017, generated from codes below.
...
bootstrap_se(d2, 1000)
```

The previous exercise derived std.error for slope as 0.15977, displayed by codes below.
