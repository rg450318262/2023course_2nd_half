...
The key points include:
  ...
  - The way we collaborate (who’s in charge of which stage and how others make 
    contribution)
...
## Details for task stages and duty allocation
  ...
  - We decided to separate the tasks into three parts (stages) and each team 
    member is responsible for one part : 
       ...
       - Rong Guang in charge of stage 1 wrangling (20 - 26 Nov)

       - Dominik Kuczkowski in charge of modeling (27 Nov - 3 Dec)

       - Karl Zhu in charge of reporting (4 Dec - 10 Dec)
...
## Details for weekly meeting
     
   - We will hold a weekly meeting on every weekend. Specific time depends on
     each member's availability
     
   - The responsible person for the week's task should breifly report and align 
     with others about what has been done and what key decision has been made.
     
   - We will also discuss general matters for the coming task. 
   
   - We may discuss and decide to modify the schedule according to real-world 
     situation, as long as the need is legitimate. 
